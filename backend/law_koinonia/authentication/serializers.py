...
class UserCreationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['username','first_name', 'last_name', 'email', 'phone_number', 'password', 'practice_court', 'current_status', 'isAdmin']
    ...
    def create(self, validated_data):
        user = User.objects.create(
            ...
            practice_court = validated_data['practice_court'],
...
class UserSerializerWithToken(UserCreationSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'first_name', 'last_name', 'username','email', 'phone_number', 'password', 'practice_court', 'current_status', 'isAdmin', 'token']
